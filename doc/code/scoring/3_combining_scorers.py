...
#
# For example, wrapping the local `PlagiarismScorer` created above scores each assistant turn independently and keeps the highest overlap score:
#
# ```python
